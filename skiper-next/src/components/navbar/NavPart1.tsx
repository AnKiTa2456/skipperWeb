...
const NavPart1 = () => {
  return (
    <div className='flex items-center gap-4'>
        ...
        <a href="#" className='text-white-500 text-sm' >Components</a>
        <a href="#" className='text-white-500 text-sm' >Pricing</a>
        <a href="#" className='text-white-500 text-sm' >Newsletter</a>
    </div>
  )
}
